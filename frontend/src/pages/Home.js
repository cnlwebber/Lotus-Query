...
const Home = () => {
    ...
    return (
        ...
        <div className="innerWrapper">
            ...
            <h2> Software </h2>
            <p> Our project utilizes <a href="https://www.mysql.com/">MySQL</a> and <a href="https://nodejs.org/en">Node.js</a> as a backend framework for storing card data. All data was collected from another project via <a href="https://mtgjson.com/">MTGJson</a>; however, the table&apos;s schema was originally created by our members. The frontend of our application is developed using <a href="https://react.dev/">React</a> for general layout and <a href="https://reactrouter.com/en/main">React-Router</a> to interface with the backend. </p>
